...
2. Revue et approbation du KYC par l'équipe TumaPlus
3. Activation du compte business par l'équipe TumaPlus (bloquée tant que l'étape 2 n'est pas faite)

Ces deux dernières étapes sont effectuées côté TumaPlus, pas par vous — comptez sur les [notifications in-app](/business/overview) pour être averti de la décision.
